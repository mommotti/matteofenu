    ...
    render() {
        return (
            <div className="condiv skills-height">
                <h1 className="subtopic">My love for UX <span style={{fontSize: "0.5em"}}>\(^o^)/</span></h1>
                <div className="about ux-w">
                    ...
                    <br></br>
                    <br></br>
                    After completing the <a  style={{color: "black", textDecoration: "underline"}} href="https://www.futurelearn.com/certificates/45vt4p4" target="_blank"> UX Course</a> provided by Accenture I am now able to present my primary UX skills:
                    <br></br>
                    <br></br>
                    ...
                    <br></br>I'm finding myself more and more passionate in learning more about how feelings, thoughts and actions can be improved by an amazing design.
